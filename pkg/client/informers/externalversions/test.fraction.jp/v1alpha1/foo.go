...
import (
	...
	test_fraction_jp_v1alpha1 "github.com/yuanying/test-controller/pkg/apis/test.fraction.jp/v1alpha1"
	versioned "github.com/yuanying/test-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yuanying/test-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/yuanying/test-controller/pkg/client/listers/test.fraction.jp/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TestV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&test_fraction_jp_v1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&test_fraction_jp_v1alpha1.Foo{}, f.defaultInformer)
}
