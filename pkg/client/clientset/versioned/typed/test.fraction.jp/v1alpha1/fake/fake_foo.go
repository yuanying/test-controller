...
var foosResource = schema.GroupVersionResource{Group: "test.fraction.jp", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "test.fraction.jp", Version: "v1alpha1", Kind: "Foo"}
