...
import (
	v1alpha1 "github.com/yuanying/test-controller/pkg/apis/test.fraction.jp/v1alpha1"
	"github.com/yuanying/test-controller/pkg/client/clientset/versioned/scheme"
...
// TestV1alpha1Client is used to interact with features provided by the test.fraction.jp group.
type TestV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TestV1alpha1Client) Foos(namespace string) FooInterface {
